...
<?php if (empty($hidden_header)): ?>
  <div class="container shopping-cart">
    <div class="language-picker-wrapper">
      <div class="language-picker"> <?php global $language ;
        $lang_name = $language->native ;?>
        <a href="#">
        <span class="countryicon-sprite iconset-shiny countrycode-<?php print $user_country_flag; ?>"></span>
        <?php print $lang_name; ?></a>
      </div>
