...
?>
  ...
  <div id="gray-shadow-head-bar"></div>
    ...
    <div class="container">
      <div class="navbar-header">
        ...
        <?php if (!empty($primary_nav) || !empty($secondary_nav) || !empty($page['navigation'])): ?>
          ...
          <button type="button" class="navbar-toggle" href="#mmenu_left">
...
<?php if (!empty($page['footer']) || !empty($page['white-footer'])): ?>
  <footer id="main-footer">
    ...
    <?php if (!empty($page['footer'])): ?>
      <div id="black-footer" class="footer navbar-inverse">
        <div class="container">
          <div class="row">
            ...
            <div class="col-xs-12 p-t-2">
              <small id="copyright" class="hidden-xs">Copyright &copy;<?php print date('Y'); ?> Fluke Inc.
              </small>
            </div>
          </div>
        </div><!-- /.container -->
