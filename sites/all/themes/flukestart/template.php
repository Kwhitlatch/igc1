 ...
 * @see html.tpl.php
 */
function flukestart_preprocess_html(&$variables) {
  // Add conditional stylesheets for IE
  $theme_path = drupal_get_path('theme', 'flukestart');
 ...
 */
function flukestart_css_alter(&$css) {
  global $language;
 ...
 * Preprocess field.
 */
function flukestart_preprocess_field(&$variables) {
 ...
 */
function flukestart_preprocess_node(&$variables) {
