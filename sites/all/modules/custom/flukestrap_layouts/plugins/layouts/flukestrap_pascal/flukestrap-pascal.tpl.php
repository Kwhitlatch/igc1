...
/**
 * @file
 * Template for flukestrap pascal.
 *
...
<div class="panel-display pascal clearfix <?php if (!empty($classes)) { print $classes; } ?><?php if (!empty($class)) { print $class; } ?>" <?php if (!empty($css_id)) { print "id=\"$css_id\""; } ?>>
